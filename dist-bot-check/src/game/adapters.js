...
exports.deploymentTemplates = void 0;
exports.findTemplateForUnitKey = findTemplateForUnitKey;
exports.createScenarioUnitFromTemplate = createScenarioUnitFromTemplate;
 ...
 */
var templateRegistry = new Map(exports.deploymentTemplates.map(function (template) { return [template.key, template]; }));
/**
 ...
 */
function findTemplateForUnitKey(unitKey) {
    var _a;
    return (_a = templateRegistry.get(unitKey)) !== null && _a !== void 0 ? _a : null;
}
/**
 ...
 */
function createScenarioUnitFromTemplate(template, hex) {
    return {
        type: template.type,
        hex: { q: hex.q, r: hex.r },
 ...
 * data.
 */
function validateTemplates(unitTypes) {
    exports.deploymentTemplates.forEach(function (template) {
        if (!unitTypes[template.type]) {
            throw new Error("Deployment template '".concat(template.key, "' references unknown unit type '").concat(template.type, "'."));
        }
    });
}
