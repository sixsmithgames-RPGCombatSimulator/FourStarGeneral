...
exports.COMBAT_PROFILES = void 0;
exports.createCombatProfileKey = createCombatProfileKey;
exports.getCombatProfile = getCombatProfile;
/**
...
exports.COMBAT_PROFILES = {
    ...
    "air.medium.antiInfantry": {
        ...
        hardAttackReference: 20,
        shotsPerTurn: 2,
        baseDamagePerHit: 25.0,
        suppressionPerHit: 25.0,
        rangeAccuracy: [
            { range: 0, accuracy: 48 },
            { range: 1, accuracy: 30 },
            { range: 2, accuracy: 18 },
 ...
 */
function createCombatProfileKey(classification) {
    var key = "".concat(classification.category, ".").concat(classification.weight, ".").concat(classification.role);
    if (Object.prototype.hasOwnProperty.call(exports.COMBAT_PROFILES, key)) {
        return key;
    }
    throw new Error("Combat profile '".concat(key, "' is not defined. Add it to src/data/combatProfiles.ts or fix the unit's combat classification."));
}
/**
 ...
 */
function getCombatProfile(classification) {
    var key = createCombatProfileKey(classification);
    return exports.COMBAT_PROFILES[key];
}
