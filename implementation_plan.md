...
- New Normandy engagements cannot select Hürtgen, Bastogne, Two Bridges, desert or other unapproved geography. Exact older packages without a profile retain their frozen template and migration path.
...
- Automated proof covers all operational tiles, actual tactical tile composition, objective feature placement, profile/template drift rejection, formation provenance, save migration and attack/defense orientation. The isolated campaign suite passes 409/409, the professional campaign UI suite passes 183/183 and the complete repository suite passes 816/816.
- Real Chromium command-flow checks pass for the Omaha-Gold beach/bluff assault, Douvres low-coastal fortified assault, Cotentin flooded approach and scheduled Caen-Orne river-crossing defense, with screenshots and DOM terrain counts from the generated precombat maps.
