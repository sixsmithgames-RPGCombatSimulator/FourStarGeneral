...
**Phase 2 — Templates and enemy spawning.** Template metadata + registry; template selection; defender roster generation into the scenario payload; amphibious variants. Retire the hardcoded `campaign → defaultScenario` mapping.
