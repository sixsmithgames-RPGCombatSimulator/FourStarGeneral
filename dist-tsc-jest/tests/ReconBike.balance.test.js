...
registerTest("LIGHT_ARMOR_DAMPENS_SMALL_ARMS_DAMAGE_WITHOUT_NULLIFYING_IT", async ({ Then }) => {
    ...
    if (infantryVsReconBike.expectedDamage >= infantryVsInfantry.expectedDamage) {
        throw new Error(`Expected recon bike armor to meaningfully reduce incoming small-arms damage, received bike ${infantryVsReconBike.expectedDamage} vs infantry ${infantryVsInfantry.expectedDamage}.`);
    }
