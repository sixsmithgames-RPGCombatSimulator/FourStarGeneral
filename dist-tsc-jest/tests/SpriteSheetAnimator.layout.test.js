...
import { COMBAT_ANIMATIONS, getSpriteSheetFrameDuration, getSpriteSheetFrameOpacity, loadSpriteSheetImage, sliceSpriteSheet, resolveSpriteSheetSpecAsync } from "../src/rendering/SpriteSheetAnimator";
...
registerTest("SPRITESHEET_ANIMATOR_EXPLOSION_SMALL_SLICE_REMAINS_STRICT_PER_CELL", async ({ Given, When, Then }) => {
    ...
    await When("the renderer slices the sheet into cached frame assets", async () => {
        ...
        frames = await sliceSpriteSheet(asset.image, COMBAT_ANIMATIONS.explosionSmall.columns, COMBAT_ANIMATIONS.explosionSmall.rows, COMBAT_ANIMATIONS.explosionSmall.frameCount, COMBAT_ANIMATIONS.explosionSmall.anchorX, COMBAT_ANIMATIONS.explosionSmall.anchorY);
    });
