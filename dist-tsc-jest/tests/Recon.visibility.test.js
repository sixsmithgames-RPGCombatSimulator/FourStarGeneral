...
function scenario(blockingHexes = []) {
...
function createEngine(playerUnits, botUnits, blockingHexes = []) {
    const cfg = {
...
function findContactAtHex(contacts, target) {
