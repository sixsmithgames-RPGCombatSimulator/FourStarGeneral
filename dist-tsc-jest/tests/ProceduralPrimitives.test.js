...
import { renderFlashCore, renderShockRing, renderSparks, renderDebris, renderDustPuff, renderSmokePuff, renderEmbers, renderScorch, SeededRandom } from "../src/rendering/ProceduralPrimitives";
const ANCHOR_X = 128;
const ANCHOR_Y = 220;
...
registerTest("SMOKE_PUFF_RISES_FROM_ANCHOR", async ({ Given, When, Then }) => {
    ...
    await Then("late-stage smoke is positioned higher than early-stage and renders as a layered plume", async () => {
        ...
        const averageCy = (elementsToMeasure) => {
