 ...
 */
function getViewSuffixForFacing(facing) {
    switch (facing) {
        case "NE":
        case "NW":
            return "Northview";
 ...
 */
export function getCompositeSpritesForUnit(scenarioType, faction, stackCount, reconStatus, facing) {
 ...
 */
export function getSpriteForScenarioType(scenarioType, faction, facing) {
 ...
 */
export const allocationKeyToScenarioType = {};
deploymentTemplates.forEach((template) => {
    allocationKeyToScenarioType[template.key] = template.type;
});
const ALLOCATION_SPRITES = {};
