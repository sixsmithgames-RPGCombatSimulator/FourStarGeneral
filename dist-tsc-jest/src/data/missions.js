...
export const missionBriefings = {
    ...
    assault: "Execute a tactical assault on enemy positions to secure strategic objectives. " +
...
const RIVER_WATCH_TURN_LIMIT_BY_DIFFICULTY = {
    Easy: 14,
    Normal: 12,
    Hard: 11
};
...
export function getMissionTurnLimit(mission, difficulty) {
