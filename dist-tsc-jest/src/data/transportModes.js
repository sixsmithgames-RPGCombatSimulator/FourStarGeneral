 ...
 */
export const TRANSPORT_MODE_FOOT = {
    key: "foot",
    label: "On Foot (March)",
 ...
 */
export const TRANSPORT_MODE_TRUCK = {
    key: "truck",
 ...
 */
export const TRANSPORT_MODE_ARMOR = {
    key: "armor",
 ...
 */
export const TRANSPORT_MODE_NAVAL = {
    key: "naval",
 ...
 */
export const TRANSPORT_MODE_WARSHIP = {
    key: "warship",
 ...
 */
export const TRANSPORT_MODE_FIGHTER = {
    key: "fighter",
 ...
 */
export const TRANSPORT_MODE_BOMBER = {
    key: "bomber",
 ...
 */
export function getApplicableTransportModes(unitType) {
    const modes = [];
 ...
 */
export function getDefaultTransportMode(unitType) {
 ...
 */
export function getUnitClassification(unitType) {
    if (INFANTRY_UNITS.includes(unitType))
        return "infantry";
    if (BOMBER_UNITS.includes(unitType))
        return "bomber";
 ...
 */
export { INFANTRY_UNITS, ARMOR_MOTORIZED_UNITS, TOWED_ARTILLERY_UNITS, NAVAL_TRANSPORT_UNITS, NAVAL_WARSHIP_UNITS, BOMBER_UNITS, FIGHTER_UNITS, LIGHT_VEHICLE_UNITS };
