function enforceUniqueTuples(tuples, label) {
    const seen = new Set();
...
function tuplesToEntries(tuples) {
    return tuples.map(([key, description]) => ({ key, description }));
}
function tuplesToKeys(tuples) {
...
export const GENERAL_MODIFIER_KEYS = tuplesToKeys(GENERAL_MODIFIER_TUPLES);
...
export const UNIT_PROPERTY_KEYS = tuplesToKeys(UNIT_PROPERTY_TUPLES);
...
export const UNIT_ARMOR_FACING_KEYS = tuplesToKeys(UNIT_ARMOR_FACING_TUPLES);
...
export const MOVE_PROFILE_KEYS = tuplesToKeys(MOVE_PROFILE_TUPLES);
...
export const UNIT_CLASS_KEYS = tuplesToKeys(UNIT_CLASS_TUPLES);
...
export const UNIT_TRAIT_KEYS = tuplesToKeys(UNIT_TRAIT_TUPLES);
...
export const TERRAIN_PROPERTY_KEYS = tuplesToKeys(TERRAIN_PROPERTY_TUPLES);
...
export const TERRAIN_NAME_KEYS = tuplesToKeys(TERRAIN_NAME_TUPLES);
...
export const TERRAIN_TYPE_KEYS = tuplesToKeys(TERRAIN_TYPE_TUPLES);
...
export const TERRAIN_DENSITY_KEYS = tuplesToKeys(TERRAIN_DENSITY_TUPLES);
...
export const TERRAIN_FEATURE_KEYS = tuplesToKeys(TERRAIN_FEATURE_TUPLES);
...
export const SCENARIO_TILE_PROPERTY_KEYS = tuplesToKeys(SCENARIO_TILE_PROPERTY_TUPLES);
...
export const SCENARIO_RECON_KEYS = tuplesToKeys(SCENARIO_RECON_TUPLES);
...
export const SCENARIO_UNIT_PROPERTY_KEYS = tuplesToKeys(SCENARIO_UNIT_PROPERTY_TUPLES);
...
export const SCENARIO_UNIT_FACING_KEYS = tuplesToKeys(SCENARIO_UNIT_FACING_TUPLES);
