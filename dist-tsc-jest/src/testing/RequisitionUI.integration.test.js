...
describe("Requisition UI Integration", () => {
    ...
    `;
        ...
        screen = new PrecombatScreen(mockScreenManager, mockBattleState);
    });
    afterEach(() => {
    ...
    describe("Supply Convoy Auto-Seeding", () => {
        it("should auto-seed supply convoy with count of 1 when no predeployed units exist", () => {
            ...
            const allocationCounts = screen.allocationCounts;
        ...
        it("should display supply convoy quantity matching the budget spent", () => {
            screen.setup("training", "general_001", "Easy");
            const budgetSpent = screen.calculateSpend();
            const allocationCounts = screen.allocationCounts;
    ...
    describe("Budget Display Accuracy", () => {
        it("should show correct spent amount when infantry is added", () => {
            ...
            screen.allocationDirty = true;
            screen.rerenderAllocations();
            screen.updateBudgetDisplay();
            const spent = screen.calculateSpend();
...
describe("Allocation UI Layout", () => {
    ...
    `;
        ...
        const testScreen = new PrecombatScreen(mockScreenManager, mockBattleState);
        // Access private method for testing
        const html = testScreen.renderAllocationItem(mockOption, 2);
