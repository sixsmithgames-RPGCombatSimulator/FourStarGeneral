    ...
    if (survivingBombers.length > 0) {
        ...
        if (attackEntriesForShow.length > 0) {
            ...
            bomberDefensePlaybackAssignments = bomberDefensePlaybackAssignments.map((assignment) => {
                ...
                const renderedLeadA = host.offsetAirShowPoint(renderedStart, blendedForward.x * 54, blendedForward.y * 54);
                const renderedLeadB = host.offsetAirShowPoint(renderedStart, blendedForward.x * 92 + targetForward.x * 28, blendedForward.y * 92 + targetForward.y * 28);
