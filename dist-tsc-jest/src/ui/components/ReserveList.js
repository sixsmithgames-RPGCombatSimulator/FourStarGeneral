...
export class PopupManager {
    ...
    renderAirSupportPanel() {
        ...
        const kindSelect = panel.querySelector("[data-air-mission-kind]");
        ...
        const form = panel.querySelector("[data-air-form]");
        const unitSelect = panel.querySelector("[data-air-unit-select]");
        const targetSelect = panel.querySelector("[data-air-target-select]");
    ...
    renderAirMissionList(list, engine) {
        ...
        const resolveSquadronLabel = (squadronId) => {
            if (!squadronId) {
                return "—";
            }
    ...
    onBattleHexClicked(event) {
        ...
        if (this.airPickMode === "target") {
            const select = panel.querySelector("[data-air-target-select]");
            if (select) {
    ...
    renderLogisticsPanel() {
        ...
        const delaysContainer = panel.querySelector("[data-logistics-delays]");
        const alertsContainer = panel.querySelector("[data-logistics-alerts]");
        const trendContainer = panel.querySelector("[data-logistics-trend]");
        ...
        if (supplyCategoriesContainer) {
            supplyCategoriesContainer.innerHTML = supplySnapshot
                ? supplySnapshot.categories.map((category) => this.composeSupplyCategoryCard(category)).join("")
