...
export class BattleLoadout {
    constructor(deploymentState, listElementSelector = "#battleLoadoutList") {
        ...
        const element = document.querySelector(listElementSelector);
        if (!element) {
    ...
    renderLoadoutItem(unitKey, label, remaining) {
