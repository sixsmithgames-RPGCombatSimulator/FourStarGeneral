 ...
 */
export function isGuestMode(authContext?: UnlockAuthContext | null): boolean {
  if (!authContext) {
    return true;
  }
 ...
 */
export function getGuestContext(authContext?: UnlockAuthContext | null): GuestContext {
 ...
 */
export function isFieldCommander(generalId: string | null | undefined): boolean {
