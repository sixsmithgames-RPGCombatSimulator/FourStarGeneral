...
export class EnhancedInitiativeTurnControls {
  ...
  private injectStyles(): void {
    if (document.querySelector('style[data-enhanced-initiative-turn-controls]')) {
      return; // Styles already injected
    }

    const style = document.createElement('style');
    style.setAttribute('data-enhanced-initiative-turn-controls', 'true');
    style.textContent = `
      .enhanced-initiative-turn-controls {
      ...
      .skip-group-btn:hover:not(:disabled) {
