...
function createSupportTruck(formationKey: "medic" | "maintenance", hex: { q: number; r: number }): ScenarioUnit {
  return {
    type: "Supply_Truck" as ScenarioUnit["type"],
    formationKey,
    hex,
...
function createStatusDamagedVehicle(hex = { q: 2, r: 0 }): ScenarioUnit {
